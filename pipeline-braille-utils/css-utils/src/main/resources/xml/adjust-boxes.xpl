...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc"
    ...
    <p:input port="source">
        <p:documentation>
            ...
            only a css:root document node, css:box elements and text nodes. Text and inline boxes
            must not have sibling block boxes.  Computed values of 'margin-left', 'margin-right',
            'border-left', 'border-top', 'border-right', 'border-bottom' and 'text-indent'
            properties must be declared in css:margin-left, css:margin-right, css:border-left,
            css:border-top, css:border-right, css:border-bottom and css:text-indent
